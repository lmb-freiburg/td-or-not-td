...
class Environment:
    def __init__(self, doom_lvl, data_format="NCHW", window_visible=False, human=False):
        ...
        self.task_type, self.cfg_path, self.input_vector_size, self.actions, \
            self.number_of_actions, self.manymaps = self.get_task_parameter(doom_lvl)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-doom_lvl', type=str, default="hg_normal", choices=tasks)
